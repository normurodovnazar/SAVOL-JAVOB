...
public class Keys {
    ...
    numberOfMyAnswers = "numberOfMyAnswers",numberOfCorrectAnswers = "numberOfCorrectAnswers",numberOfIncorrectAnswers = "numberOfIncorrectAnswers",
            ...
            errorRecaptcha = "",
            errorVerificationCode = "The sms verification code used to create the phone auth credential is invalid. Please resend the verification code sms and be sure use the verification code provided by the user.",
            errorInternetWhenCode = "A network error (such as timeout, interrupted connection or unreachable host) has occurred.";
}
