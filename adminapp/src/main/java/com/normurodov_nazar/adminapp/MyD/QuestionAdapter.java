...
public class QuestionAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    final ItemClickForQuestion longClick;
    final boolean loadMoreFunction;
    final QuestionFrom from;

    public QuestionAdapter(Context context, ArrayList<Question> questions, QuestionFrom from,boolean loadMoreFunction, ItemClickForQuestion listener,ItemClickForQuestion longClick) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (loadMoreFunction) {
            if (position != questions.size()) {
                ...
                ((QViewHolder) holder).setQuestion(question, listener,longClick, position,from);
    ...
    static class QViewHolder extends RecyclerView.ViewHolder {
        ...
        void setQuestion(Question question, ItemClickForQuestion listener, ItemClickForQuestion longClick,int pos,QuestionFrom from) {
            ...
            itemView.setOnLongClickListener(c-> {
                longClick.onItemClick(pos,"",null);
                return true;
            });
